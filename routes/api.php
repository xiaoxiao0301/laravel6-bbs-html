...
$api->version('v1', [
    ...
    $api->group([
        ...
        $api->get('topics/{topic}', 'TopicsController@show')->name('api.topcis.show');
        // 话题回复列表
        ...
        $api->group(['middleware' => 'api.auth'], function($api){
            ...
            // 通知列表
            $api->get('user/notifications', 'NotificationsController@index')->name('api.user.notificatons.index');
            // 通知统计
